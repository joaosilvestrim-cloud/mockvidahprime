...
// Só liga a assinatura na ZapSign quando ZAPSIGN_ENABLED=true E houver token.
// Enquanto desligada, o cadastro usa o aceite eletrônico interno.
// Para ativar (após contratar o Plano de API da ZapSign): setar ZAPSIGN_ENABLED=true no Vercel e redeployar.
export function zapConfigured() {
  return process.env.ZAPSIGN_ENABLED === "true" && !!process.env.ZAPSIGN_API_TOKEN;
}
